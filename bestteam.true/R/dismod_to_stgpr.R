################################################################################
# HMS 520
# Bundle Converter: DisMod to STGPR
# Authors: Lauryn Stafford and Jessica Bishai
################################################################################

#' DisMod to ST-GPR Bundle Converter
#'
#' @param input_dismod_bundle Bundle data in DisMod shape.
#'
#' @return The inputted bundle data, converted to ST-GPR shape.
#' @export
#'
#' @examples dismod_to_stgpr(diabetes_dismod_bundle)
dismod_to_stgpr <- function(input_dismod_bundle){
  ...
  recall_type_converter <- function(val) {
    ...
    recall_type <- c("Not Set", "Point", "Lifetime", "Period: years",
                     "Period: months", "Period: weeks", "Period: days")
  ...
  representative_type_converter <- function(val){
    ...
    representative_type_map <- data.frame(id = -1:11,
  ...
  sampling_type_converter <- function(val){
    ...
    sampling_type_map <- data.frame(id = c(-1, 1:5),
                                    type = as.character(sampling_type))
  ...
  source_type_converter <- function(val){
    ...
    source_type_long = c("DSP before 1990", "Vital Registration",
                         ...
                         "Other survey",
                         "UNICEF", "Vital Registration (1978-2008)",
                         ...
                         "Vital Registration after 1978",
                         "other")
    source_type_map = data.frame(id = 0:26,
  ...
  var_names <- c("input", "recall", "representative", "sampling", "source",
                 "uncertainty")
